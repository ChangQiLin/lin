      ...
      <div class="login logns produce">
        <h1 class="blues">拍卖品信息</h1>
          <dl>
            ...
            <dd>
              <label>起拍价：</label>
              <input type="text" class="inputh lf" value="" name="auction_start_price"/>
              <div class="lf red laba">必须为数字</div>
            </dd>
            <dd>
              <label>底价：</label>
              <input type="text" class="inputh lf" value="" name="auction_upset"/>
              <div class="lf red laba">必须为数字</div>
            </dd>
            <!-- <dd>
              <label>开始时间：</label>
            ...
            <dd class="dds">
             ...
             <dd class="dds">
              <label>描述：</label>
              <textarea  cols="" rows="" class="textarea" name="auction_desc"></textarea>
            </dd>
            <dd class="hegas">
