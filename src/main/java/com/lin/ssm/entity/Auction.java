...
public class Auction {
	...
	public Auction(String auction_name, Double auction_start_price,
			Double auction_upset, Date auction_end_time, String auction_pic,
			String auction_desc) {
		super();
	...
	public Auction(Date auction_start_time, Date auction_end_time) {
		super();
		this.auction_start_time = auction_start_time;
		this.auction_end_time = auction_end_time;
	}
	public Auction(Double auction_start_price) {
		super();
		this.auction_start_price = auction_start_price;
	}
	public Auction(String auction_name, String auction_desc) {
		super();
		this.auction_name = auction_name;
		this.auction_desc = auction_desc;
	}
